...
var handleRequest = function(request, response) {
    ...
    if (url === '/') {
        //url = '?/index.html';
        fs.readFile(/*'./src/html/maintenance.html'*/'./index.html', function(err, data) {
            if (err) {
    ...
    } else if (url === '/inside/src/js/maintenance.js') {
        fs.readFile('./src/js/maintenance.js', function(err, data) {
            if (err) {
                response.writeHead(404, 'Not Found.');
                response.end();
                throw err;
